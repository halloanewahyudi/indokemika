        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10 items-center">
            <div class="">
                ...
                <div class="">
                    ...
                    <router-link class="btn"> Read more</router-link>
                </div>
                ...
                <Splide ref="splide" :options="{
                    ...
                    <SplideSlide v-for="(item, index) in products" :key="index" class="">
                        <div class="rounded-xl overflow-hidden relative text-center bg-black">
                            ...
                            <div class="p-4 bg-primary-600 h-full">
                                <span class="font-semibold text-primary-50">{{ item.name }}</span>
                            </div>
                        </div>
                    </SplideSlide>
                </Splide>
                <div class="flex items-center  w-full gap-4 p-6 text-primary-950">
                    <button @click="goPrev" class=" w-10 h-10 shrink-0 flex justify-center items-center rounded-full bg-primary-600 text-white hover:bg-secondary-200 hover:text-primary-600 duration-300">
                        <IconArrowLeftVue class="" />
                    </button>
                    <button @click="goNext" class=" w-10 h-10 shrink-0 flex justify-center items-center rounded-full bg-primary-600 text-white hover:bg-secondary-200 hover:text-primary-600 duration-300">
                        <IconArrowRightVue />
                    </button>
                </div>
            </div>
